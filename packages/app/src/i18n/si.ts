export const dict: Record<string, string> = {
  ...
  "mcp.app.loading": "යෙදුම පූරණය වෙමින්…",
  "mcp.app.retry": "නැවත උත්සාහ කරන්න",
  "mcp.app.notConfigured": "MCP සේවාදායකය වින්‍යාස කර නොමැත",
  "mcp.app.needsAuth": "MCP සේවාදායකයට සත්‍යාපනය අවශ්‍යයි",
  "mcp.app.connectFailed": "MCP සේවාදායකය සමඟ සම්බන්ධ වීම අසාර්ථක විය",
  "mcp.app.connectTimeout": "MCP සේවාදායක සම්බන්ධතාවයේ කාලය ඉක්මවිය",
  "mcp.app.panel.empty": "කිසිදු MCP යෙදුමක් නොමැත",
  "mcp.app.panel.title": "යෙදුම්",
