export const dict = {
  ...
  "mcp.app.loading": "アプリを読み込み中…",
  "mcp.app.retry": "再試行",
  "mcp.app.notConfigured": "MCP サーバーが設定されていません",
  "mcp.app.needsAuth": "MCP サーバーには認証が必要です",
  "mcp.app.connectFailed": "MCP サーバーに接続できませんでした",
  "mcp.app.connectTimeout": "MCP サーバーの接続がタイムアウトしました",
  "mcp.app.panel.empty": "利用可能な MCP アプリがありません",
  "mcp.app.panel.title": "アプリ",
