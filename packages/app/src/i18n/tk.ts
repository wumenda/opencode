export const dict = {
  ...
  "mcp.app.loading": "Programma ýüklenýär…",
  "mcp.app.retry": "Täzeden synanyş",
  "mcp.app.notConfigured": "MCP serweri konfigurasiya edilmedik",
  "mcp.app.needsAuth": "MCP serweri tankytlamany talap edýär",
  "mcp.app.connectFailed": "MCP serwerine birikmek şowsuz boldy",
  "mcp.app.connectTimeout": "MCP serwerine birikmek wagtysy gutardy",
  "mcp.app.panel.empty": "Elýeterli MCP programalary ýok",
  "mcp.app.panel.title": "Programmalar",
