export const dict = {
  ...
  "mcp.app.loading": "Се вчитува апликацијата…",
  "mcp.app.retry": "Обиди се повторно",
  "mcp.app.notConfigured": "MCP серверот не е конфигуриран",
  "mcp.app.needsAuth": "MCP серверот бара автентикација",
  "mcp.app.connectFailed": "Не успеа поврзувањето со MCP серверот",
  "mcp.app.connectTimeout": "Истече времето за поврзување со MCP серверот",
  "mcp.app.panel.empty": "Нема достапни MCP апликации",
  "mcp.app.panel.title": "Апликации",
