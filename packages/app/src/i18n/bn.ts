export const dict: Record<string, string> = {
  ...
  "mcp.app.loading": "অ্যাপ লোড হচ্ছে…",
  "mcp.app.retry": "আবার চেষ্টা করুন",
  "mcp.app.notConfigured": "MCP সার্ভার কনফিগার করা নেই",
  "mcp.app.needsAuth": "MCP সার্ভারে প্রমাণীকরণ প্রয়োজন",
  "mcp.app.connectFailed": "MCP সার্ভারে সংযোগ ব্যর্থ হয়েছে",
  "mcp.app.connectTimeout": "MCP সার্ভার সংযোগের সময়সীমা শেষ হয়েছে",
  "mcp.app.panel.empty": "কোনো MCP অ্যাপ উপলব্ধ নেই",
  "mcp.app.panel.title": "অ্যাপ",
