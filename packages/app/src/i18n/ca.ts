export const dict = {
  ...
  "mcp.app.loading": "S'està carregant l'aplicació…",
  "mcp.app.retry": "Torna-ho a provar",
  "mcp.app.notConfigured": "El servidor MCP no està configurat",
  "mcp.app.needsAuth": "El servidor MCP requereix autenticació",
  "mcp.app.connectFailed": "No s'ha pogut connectar al servidor MCP",
  "mcp.app.connectTimeout": "S'ha esgotat el temps de connexió al servidor MCP",
  "mcp.app.panel.empty": "No hi ha cap aplicació MCP disponible",
  "mcp.app.panel.title": "Aplicacions",
