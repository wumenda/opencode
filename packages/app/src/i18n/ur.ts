export const dict = {
  ...
  "mcp.app.loading": "ایپ لوڈ ہو رہی ہے…",
  "mcp.app.retry": "دوبارہ کوشش کریں",
  "mcp.app.notConfigured": "MCP سرور کنفیگر نہیں ہے",
  "mcp.app.needsAuth": "MCP سرور کو تصدیق کی ضرورت ہے",
  "mcp.app.connectFailed": "MCP سرور سے رابطہ ناکام ہو گیا",
  "mcp.app.connectTimeout": "MCP سرور رابطے کی وقت ختم ہو گیا",
  "mcp.app.panel.empty": "کوئی MCP ایپ دستیاب نہیں",
  "mcp.app.panel.title": "ایپس",
