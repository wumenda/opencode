export const dict = {
  ...
  "mcp.app.loading": "Φόρτωση της εφαρμογής…",
  "mcp.app.retry": "Δοκιμή ξανά",
  "mcp.app.notConfigured": "Ο διακομιστής MCP δεν έχει ρυθμιστεί",
  "mcp.app.needsAuth": "Ο διακομιστής MCP απαιτεί έλεγχο ταυτότητας",
  "mcp.app.connectFailed": "Απέτυχε η σύνδεση στον διακομιστή MCP",
  "mcp.app.connectTimeout": "Έληξε το χρονικό όριο σύνδεσης στον διακομιστή MCP",
  "mcp.app.panel.empty": "Δεν υπάρχουν διαθέσιμες εφαρμογές MCP",
  "mcp.app.panel.title": "Εφαρμογές",
