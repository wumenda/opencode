export const dict = {
  ...
  "mcp.app.loading": "앱을 불러오는 중…",
  "mcp.app.retry": "다시 시도",
  "mcp.app.notConfigured": "MCP 서버가 구성되지 않았습니다",
  "mcp.app.needsAuth": "MCP 서버에 인증이 필요합니다",
  "mcp.app.connectFailed": "MCP 서버에 연결하지 못했습니다",
  "mcp.app.connectTimeout": "MCP 서버 연결 시간이 초과되었습니다",
  "mcp.app.panel.empty": "사용 가능한 MCP 앱이 없습니다",
  "mcp.app.panel.title": "앱",
