export const dict = {
  ...
  "mcp.app.loading": "აპის ჩატვირთვა…",
  "mcp.app.retry": "თავიდან სცადეთ",
  "mcp.app.notConfigured": "MCP სერვერი კონფიგურირებული არაა",
  "mcp.app.needsAuth": "MCP სერვერი აუთენტიფიკაციას მოითხოვს",
  "mcp.app.connectFailed": "MCP სერვერთან დაკავშირება ჩავარდა",
  "mcp.app.connectTimeout": "MCP სერვერთან დაკავშირების დრო ამოიწურა",
  "mcp.app.panel.empty": "ხელმისაწვდომი MCP აპები არ არის",
  "mcp.app.panel.title": "აპები",
