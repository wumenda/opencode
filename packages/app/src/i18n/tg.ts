export const dict = {
  ...
  "mcp.app.loading": "Барнома бор карда мешавад…",
  "mcp.app.retry": "Аз нав кӯшиш кунед",
  "mcp.app.notConfigured": "Сервери MCP танзим нашудааст",
  "mcp.app.needsAuth": "Сервери MCP санҷиши ҳувият талаб мекунад",
  "mcp.app.connectFailed": "Пайвастшавӣ ба сервери MCP ба амал наомад",
  "mcp.app.connectTimeout": "Вақти пайвастшавӣ ба сервери MCP тамом шуд",
  "mcp.app.panel.empty": "Ҳеҷ барномаи MCP дастрас нест",
  "mcp.app.panel.title": "Барномаҳо",
