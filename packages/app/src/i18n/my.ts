export const dict = {
  ...
  "mcp.app.loading": "အက်ပ် တင်နေသည်…",
  "mcp.app.retry": "ထပ်စမ်းကြည့်ပါ",
  "mcp.app.notConfigured": "MCP ဆာဗာကို စနစ်တကျ မထားရှိပါ",
  "mcp.app.needsAuth": "MCP ဆာဗာတွင် အထောက်အထားပြ လိုအပ်သည်",
  "mcp.app.connectFailed": "MCP ဆာဗာသို့ ချိတ်ဆက်မှု မအောင်မမြင် ဖြစ်သည်",
  "mcp.app.connectTimeout": "MCP ဆာဗာ ချိတ်ဆက်မှု အချိန်ကုန်သွားသည်",
  "mcp.app.panel.empty": "MCP အက္ပများ မရရှိနိုင်ပါ",
  "mcp.app.panel.title": "အက္ပများ",
