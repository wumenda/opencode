export const dict = {
  ...
  "mcp.app.loading": "መተግበሪያ በመጫን ላይ…",
  "mcp.app.retry": "እንደገና ሞክር",
  "mcp.app.notConfigured": "የMCP ሰርቨር አልተዋቀረም",
  "mcp.app.needsAuth": "የMCP ሰርቨር ማረጋገጫ ይፈልጋል",
  "mcp.app.connectFailed": "ከMCP ሰርቨር ጋር መገናኘት አልተሳካም",
  "mcp.app.connectTimeout": "የMCP ሰርቨር ግንኙነት ጊዜ አልፏል",
  "mcp.app.panel.empty": "ምንም MCP መተግበሪያ አልተገኘም",
  "mcp.app.panel.title": "መተግበሪያዎች",
