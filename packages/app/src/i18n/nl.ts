export const dict = {
  ...
  "mcp.app.loading": "App wordt geladen…",
  "mcp.app.retry": "Opnieuw proberen",
  "mcp.app.notConfigured": "MCP-server is niet geconfigureerd",
  "mcp.app.needsAuth": "MCP-server vereist authenticatie",
  "mcp.app.connectFailed": "Verbinding met MCP-server mislukt",
  "mcp.app.connectTimeout": "Time-out bij verbinding met MCP-server",
  "mcp.app.panel.empty": "Geen MCP-apps beschikbaar",
