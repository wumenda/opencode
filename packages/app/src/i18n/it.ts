export const dict = {
  ...
  "mcp.app.loading": "Caricamento dell'app…",
  "mcp.app.retry": "Riprova",
  "mcp.app.notConfigured": "Il server MCP non è configurato",
  "mcp.app.needsAuth": "Il server MCP richiede l'autenticazione",
  "mcp.app.connectFailed": "Connessione al server MCP non riuscita",
  "mcp.app.connectTimeout": "Timeout della connessione al server MCP",
  "mcp.app.panel.empty": "Nessuna app MCP disponibile",
  "mcp.app.panel.title": "App",
