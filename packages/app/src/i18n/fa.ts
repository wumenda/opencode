export const dict = {
  ...
  "mcp.app.loading": "در حال بارگیری برنامه…",
  "mcp.app.retry": "تلاش مجدد",
  "mcp.app.notConfigured": "سرور MCP پیکربندی نشده است",
  "mcp.app.needsAuth": "سرور MCP نیازمند احراز هویت است",
  "mcp.app.connectFailed": "اتصال به سرور MCP ناموفق بود",
  "mcp.app.connectTimeout": "مهلت اتصال به سرور MCP به پایان رسید",
  "mcp.app.panel.empty": "هیچ برنامه MCP در دسترس نیست",
  "mcp.app.panel.title": "برنامه‌ها",
