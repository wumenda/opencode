...
export const dict = {
  ...
  "mcp.app.retry": "Pokušaj ponovno",
  "mcp.app.notConfigured": "MCP poslužitelj nije konfiguriran",
  "mcp.app.needsAuth": "MCP poslužitelj zahtijeva autentifikaciju",
  "mcp.app.connectFailed": "Povezivanje s MCP poslužiteljem nije uspjelo",
  "mcp.app.connectTimeout": "Isteklo je vrijeme za povezivanje s MCP poslužiteljem",
