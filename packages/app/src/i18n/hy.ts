export const dict = {
  ...
  "mcp.app.loading": "Բեռնում է հավելվածը…",
  "mcp.app.retry": "Կրկին փորձել",
  "mcp.app.notConfigured": "MCP սերվերը կազմաձևված չէ",
  "mcp.app.needsAuth": "MCP սերվերը պահանջում է նույնականացում",
  "mcp.app.connectFailed": "Չհաջողվեց միանալ MCP սերվերին",
  "mcp.app.connectTimeout": "MCP սերվերի միացման ժամանակը սպառվեց",
  "mcp.app.panel.empty": "MCP հավելվածներ հասանելի չեն",
  "mcp.app.panel.title": "Հավելվածներ",
