  ...
  return (
    <div className="relative flex h-full items-center justify-center overflow-hidden bg-bg">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 50% 45%, var(--bg3) 0%, var(--bg) 70%)',
        }}
      />
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative mb-6 flex h-20 w-20 items-center justify-center">
          ...
          <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-accent/15 [animation-delay:400ms]" />
          <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-accent/10 [animation-delay:800ms]" />

          {/* 中央徽标 */}
          <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-accent shadow-lg shadow-accent/30 animate-breathe">
            <svg
