...
export function ErrorBanner({
  ...
  return (
    <div className="m-4 rounded-md border border-red/30 bg-red/5 p-4">
      <div className="flex items-center gap-2">
        ...
        <div className="ml-auto flex gap-2">
          {onRetry && (
            <button
              className="rounded border border-red/40 bg-red/10 px-2.5 py-1 text-[11px] text-red hover:bg-red/20"
              onClick={onRetry}
            >
              重试提取
            </button>
          ...
          <button
            className="rounded border border-border bg-bg-3 px-2.5 py-1 text-[11px] text-text-2 hover:border-text-3"
